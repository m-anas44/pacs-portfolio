...
export default function LabHero() {
  ...
  return (
    <>
      ...
      <section className="relative pt-24 pb-24 lg:pt-24 lg:pb-24 overflow-hidden bg-white border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <motion.h1
                ...
                className="font-heading text-5xl md:text-7xl font-black tracking-tighter text-slate-900 leading-[0.85] mb-8"
              >
                Where Theory <br />
