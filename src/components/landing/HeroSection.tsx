      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        ...
        >
          <motion.span
            ...
            className="inline-block px-4 py-1.5  text-xs sm:text-sm font-bold tracking-wide text-(--emerald-700) uppercase bg-(--emerald-100) rounded-full"
          >
          ...
          <motion.h1
            ...
            className="font-heading text-4xl md:text-6xl font-black tracking-tighter text-slate-900 mb-10"
          >
            <span className="text-transparent bg-clip-text bg-linear-to-r from-slate-900 via-emerald-600 to-slate-900">
              Master Your Board Exams with <br />
            </span>
            Confidence.
          </motion.h1>
          ...
          >
            Complete preparation for Class 8th, Matric, and FSc/ICS based on the
            latest Board Syllabus. Start your journey today—no need to wait for
            a session!
          </motion.p>
          ...
          >
            {[
              ...
              <span
                key={cls}
                className="px-2 py-1 bg-slate-100 text-slate-500 text-[10px] sm:text-xs font-semibold rounded-md uppercase border-l-2 border-(--emerald-500)"
              >
                {cls}
              </span>
            ))}
